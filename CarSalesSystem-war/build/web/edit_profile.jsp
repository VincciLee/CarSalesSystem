    ...
    <body>
                        ...
                        <div class="col-md-3 border-right">
                            <div class="d-flex flex-column align-items-center text-center p-3 py-5 form-outline">
                                <c:if test="${not empty user.getProfile()}">
                                    <img class="rounded-circle mt-5" width="150px" height="150px" src="CarSalesSystem/images/${user.getProfile()}">                                    
                                </c:if>
        ...
        <script>
            if (performance.navigation.type === performance.navigation.TYPE_RELOAD) {
                window.location.replace("http://localhost:8080/CarSalesSystem-war/Edit_Profile");
            }
        </script>
