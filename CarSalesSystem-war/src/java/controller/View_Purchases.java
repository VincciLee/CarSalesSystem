 ...
 * @author Vincci
 */
@WebServlet(name = "View_Purchases", urlPatterns = {"/View_Purchases"})
public class View_Purchases extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Sales> purchases = salesFacade.getAllPurchases(user_id, status);
