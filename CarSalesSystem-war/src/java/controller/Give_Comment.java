 ...
 * @author Vincci
 */
@WebServlet(name = "Give_Comment", urlPatterns = {"/Give_Comment"})
public class Give_Comment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            sales.setSalesman_comment(comment);
            salesFacade.edit(sales);

            request.setAttribute("id", sales_id);
            request.setAttribute("success", "Comment submitted!");
            request.getRequestDispatcher("Sales_History?status=All").forward(request, response);
        }
    }
