 ...
 * @author Vincci
 */
@WebServlet(name = "Cancel_Sales", urlPatterns = {"/Cancel_Sales"})
public class Cancel_Sales extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            new_sales.setStatus("Canceled");
            new_sales.setCanceled_date(date);
            ...
            request.setAttribute("success", "Booking canceled!");
